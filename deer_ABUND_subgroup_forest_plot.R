...
mixed_effect_abundance_nesting <- rma(yi, # outcome
                                      vi, # measure of variance
                                      mods = ~ Nesting_Location, # multiple moderating variables modeled as main effects
                                      method = "DL",
                                      data = effect_sizes_abundance,
                                      slab = paste(author, pub_year, sep = ""))
mixed_effect_abundance_nesting

#### Forest plot using metaviz ####

# Summary forest plot by nesting type
viz_forest(x = mixed_effect_abundance_nesting, 
           method = "DL",
